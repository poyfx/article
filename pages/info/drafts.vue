		...
		<mescroll-body ref="mescrollRef" @init="mescrollInit" @down="downCallback" @up="upCallback" :down="downOption" :up="upOption">
			...
			<view class="info_content">
				<view class="info_myinfo_content bgcf" v-for="(item,index) in articleInfo" :key="index">
					...
					<!-- 草稿箱 -->
					<view class="info_article bgcf flex border-Bottom" @tap="articleDetile(item.publishType,item.id)">
		...
		methods: {
			...
			articleDetile(num, id) {
				...
				if (num == 1) {
					...
					// uni.navigateTo({
					// 	url:'../article/original/edit/edit?type=c'+'&id='+id
					// })
				} else {
					...
					// uni.navigateTo({
					// 	url:'../article/reprint/editingArticles/editingArticles?type=c'+'&id='+id
					// })
				}
			},
			upCallback(page) {
