		...
		<mescroll-body ref="mescrollRef" @init="mescrollInit" @down="downCallback" @up="upCallback" :down="downOption" :up="upOption">
			...
			<view class="info_content">
				<view class="info_myinfo_content bgcf" v-for="(item,index) in articleInfo" :key="index">
					<view class="info_article bgcf flex border-Bottom" @tap="statistics(item.id,item.publishType)">
						...
						<view class="info_article_number">
							{{item.access_count}}
						</view>
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			statistics(id, type) {
				uni.navigateTo({
					url: './articleStatistics?id=' + id + '&type=' + type
				})
			},
		},
		components: {
